//std::isspace considered harmful. Time to kick locale from the language because it violates zero overhead principle
/*
$ ./isspace.exe
std::isspace:   0.900008s
misspace1:      0.331s
misspace2:      0.329s
misspace3:      0.26898700000000003s
misspace4:      0.274999s
fastisspace:    0.219001s
fastisspacerev: 0s
fastisspacerev2:        0.131999s
fastisspacerev3:        0s
fastisspacerev4:        0s
total value: 0
...
int main()
{
	std::array<char,12> a={'a',u8'e',u8'f',105,'a',u8'e',u8'f',105,'a',u8'e',u8'f',105};
	...
	static_assert(fastisspacerev4(' '),u8"false");
	{
