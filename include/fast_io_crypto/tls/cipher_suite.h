...
inline constexpr void print_define(output& outp,cipher_suite_type const& e)
{
	if(e==tls_rsa_with_null_null)
		print(outp,u8"TLS_RSA_WITH_NULL_NULL{0x00,0x00}");
	else if(e==tls_rsa_with_null_md5)
		print(outp,u8"TLS_RSA_WITH_NULL_MD5{0x00,0x01}");
	else if(e==tls_rsa_with_null_sha)
		print(outp,u8"TLS_RSA_WITH_NULL_SHA{0x00,0x02}");
	else if(e==tls_rsa_with_null_sha256)
		print(outp,u8"TLS_RSA_WITH_NULL_SHA256{0x00,0x3B}");
	else if(e==tls_rsa_with_rc4_128_md5)
		print(outp,u8"TLS_RSA_WITH_RC4_128_MD5{0x00,0x04}");
	else if(e==tls_rsa_with_rc4_128_sha)
		print(outp,u8"TLS_RSA_WITH_RC4_128_SHA{0x00,0x05}");
	else if(e==tls_rsa_with_3des_ede_cbc_sha)
		print(outp,u8"TLS_RSA_WITH_3DES_EDE_CBC_SHA{0x00,0x0A}");	
	else if(e==tls_rsa_with_aes_128_cbc_sha)
		print(outp,u8"TLS_RSA_WITH_AES_128_CBC_SHA{0x00,0x2F}");
	else if(e==tls_rsa_with_aes_256_cbc_sha)
		print(outp,u8"TLS_RSA_WITH_AES_256_CBC_SHA{0x00,0x35}");
	else if(e==tls_rsa_with_aes_128_cbc_sha256)
		print(outp,u8"TLS_RSA_WITH_AES_128_CBC_SHA256{0x00,0x3C}");
	else if(e==tls_rsa_with_aes_256_cbc_sha256)
		print(outp,u8"TLS_RSA_WITH_AES_256_CBC_SHA256{0x00,0x3D}");
	else if(e==tls_dh_dss_with_3des_ede_cbc_sha)
		print(outp,u8"TLS_DH_DSS_WITH_3DES_EDE_CBC_SHA{0x00,0x0D}");
	else if(e==tls_dh_rsa_with_3des_ede_cbc_sha)
		print(outp,u8"TLS_DH_RSA_WITH_3DES_EDE_CBC_SHA{0x00,0x10}");
	else if(e==tls_dhe_dss_with_3des_ede_cbc_sha)
		print(outp,u8"TLS_DHE_RSS_WITH_3DES_EDE_CBC_SHA{0x00,0x13}");
	else if(e==tls_dhe_rsa_with_3des_ede_cbc_sha)
		print(outp,u8"TLS_DHE_RSS_WITH_3DES_EDE_CBC_SHA{0x00,0x16}");
	else if(e==tls_dh_dss_with_aes_128_cbc_sha)
		print(outp,u8"TLS_DH_DSS_WITH_AES_128_CBC_SHA{0x00,0x30}");
	else if(e==tls_dh_rsa_with_aes_128_cbc_sha)
		print(outp,u8"TLS_DH_RSA_WITH_AES_128_CBC_SHA{0x00,0x31}");
	else if(e==tls_dhe_dss_with_aes_128_cbc_sha)
		print(outp,u8"TLS_DHE_DSS_WITH_AES_128_CBC_SHA{0x00,0x32}");
	else if(e==tls_dhe_rsa_with_aes_128_cbc_sha)
		print(outp,u8"TLS_DHE_RSA_WITH_AES_128_CBC_SHA{0x00,0x33}");
	else if(e==tls_dh_dss_with_aes_256_cbc_sha)
		print(outp,u8"TLS_DH_DSS_WITH_AES_256_CBC_SHA{0x00,0x36}");
	else if(e==tls_dh_rsa_with_aes_256_cbc_sha)
		print(outp,u8"TLS_DH_RSA_WITH_AES_256_CBC_SHA{0x00,0x37}");
	else if(e==tls_dhe_dss_with_aes_256_cbc_sha)
		print(outp,u8"TLS_DHE_DSS_WITH_AES_256_CBC_SHA{0x00,0x38}");
	else if(e==tls_dhe_rsa_with_aes_256_cbc_sha)
		print(outp,u8"TLS_DHE_RSA_WITH_AES_256_CBC_SHA{0x00,0x39}");
	else if(e==tls_dh_dss_with_aes_128_cbc_sha256)
		print(outp,u8"TLS_DH_DSS_WITH_AES_128_CBC_SHA256{0x00,0x3e}");
	else if(e==tls_dh_rsa_with_aes_128_cbc_sha256)
		print(outp,u8"TLS_DH_RSA_WITH_AES_128_CBC_SHA256{0x00,0x3f}");
	else if(e==tls_dhe_dss_with_aes_128_cbc_sha256)
		print(outp,u8"TLS_DHE_DSS_WITH_AES_128_CBC_SHA256{0x00,0x40}");
	else if(e==tls_dhe_rsa_with_aes_128_cbc_sha256)
		print(outp,u8"TLS_DHE_RSA_WITH_AES_128_CBC_SHA256{0x00,0x67}");
	else if(e==tls_dh_dss_with_aes_256_cbc_sha256)
		print(outp,u8"TLS_DH_DSS_WITH_AES_256_CBC_SHA256{0x00,0x68}");
	else if(e==tls_dh_rsa_with_aes_256_cbc_sha256)
		print(outp,u8"TLS_DH_RSA_WITH_AES_256_CBC_SHA256{0x00,0x69}");
