 ...
 * z^(p - 2) = z(2^255 - 21)
 */
inline void curve25519_recip(bignum25519 out, bignum25519 const z)
{
	alignas(16) bignum25519 a,t0,b;
 ...
 * z^((p-5)/8) = z^(2^252 - 3)
 */
inline void curve25519_pow_two252m3(bignum25519 two252m3, bignum25519 const z)
{
	alignas(16) bignum25519 b,c,t0;
