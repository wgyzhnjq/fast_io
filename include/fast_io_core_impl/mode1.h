...
inline static mode constexpr directory{1<<4};
inline static mode constexpr excl{1<<5};//C++ iostream currently still does not support "x"
inline static mode constexpr in{1<<6};
inline static mode constexpr inherit{1<<7};
inline static mode constexpr out{1<<8};
inline static mode constexpr overlapped{1<<9};
inline static mode constexpr reparse_point{1<<10};
inline static mode constexpr sync{1<<11};
