...
public:
	...
	constexpr basic_file_wrapper(std::u8string_view file,open::interface_t<om>,perms_interface_t<pm>):T(file,open::interface<fast_io::open::mode(om|interface_mode)>,perms_interface<pm>){}
	template<std::size_t om>
	constexpr basic_file_wrapper(std::u8string_view file,open::interface_t<om>):T(file,open::interface<fast_io::open::mode(om|interface_mode)>){}
	template<perms pm>
	constexpr basic_file_wrapper(std::u8string_view file,perms_interface_t<pm>):T(file,open::interface<fast_io::open::mode(interface_mode)>,perms_interface<pm>){}
	constexpr basic_file_wrapper(std::u8string_view file):T(file,open::interface<fast_io::open::mode(interface_mode)>){}
	constexpr basic_file_wrapper(std::u8string_view file,open::mode const& m,perms p=static_cast<perms>(420)):T(file,m|fast_io::open::mode(interface_mode),p){}
	constexpr basic_file_wrapper(std::u8string_view file,std::u8string_view mode,perms p=static_cast<perms>(420)):basic_file_wrapper(file,fast_io::open::c_style(mode),p){}
	constexpr basic_file_wrapper(std::u8string_view file,perms pm):T(file,open::interface<fast_io::open::mode(interface_mode)>,pm){}
};
...
public:
	...
	constexpr basic_wrapper(std::u8string_view mode):basic_wrapper(fast_io::open::c_style(mode)){}
};
