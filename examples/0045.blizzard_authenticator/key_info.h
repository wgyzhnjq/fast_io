...
{
	print(out,u8"Time difference:",ref.reference.time_difference,
		"s\tBlizzard Auth Server Time since epoch:",
		server_time(ref.reference),
		"s\nSerial:",ref.reference.serial,u8"\tKey:",fast_io::base_split<bas,uppercase>(ref.reference.secret_key,u8',u8'),
